...
namespace Frcho\SimplePaginatorBundle\Paginator;

use
 Symfony\Component\HttpFoundation\RequestStack,
    Frcho\SimplePaginatorBundle\Paginator\Adapter\AdapterFactory
;
...
class Paginator
{
     ...
     * @param string $id
     * @return Frcho\SimplePaginatorBundle\Paginator
     */
