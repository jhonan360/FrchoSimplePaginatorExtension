...
namespace Frcho\SimplePaginatorBundle\Templating\Helper;
...
class PaginatorHelper extends Helper
{
    ...
    /**
     *  @return Frcho\SimplePaginatorBundle\Paginator\Paginator
     */
    public function getPaginator()
    {
        return $this->container->get('frcho.simple_paginator');
    }
    ...
    {
        $view = (!is_null($view)) ? $view : 'FrchoSimplePaginatorBundle:Paginator:simple-paginator-list-view.html.twig';
