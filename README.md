...
Add FrchoSimplePaginatorBundle in your composer.json:
...
``` bash
$ php composer.phar update frcho/simple-paginator-bundle
```

Composer will install the bundle to your project's `vendor/frcho` directory.
...
public function registerBundles()
{
    $bundles = array(
      ...
        new Frcho\SimplePaginatorBundle\FrchoSimplePaginatorBundle(),
      );
}
```
... so you are ready now to use FrchoSimplePaginatorBundle as a service.
...
class MyController extends Controller
{
  public function listAction() {
    $paginator = $this->get('frcho.simple_paginator');
...
```xml
<parameters>
  <parameter key="simple_paginador.class">Frcho\SimplePaginatorBundle\Paginator\Paginator</parameter>
</parameters>

<services>
  <service id="frcho.simple_paginator" class="%simple_paginator.class%">
